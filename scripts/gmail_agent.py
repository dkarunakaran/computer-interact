...
class GmailAgent:
    def __init__(self):
        ...
        self.context = """
            ...
            You have also got the capability to navaigate to the url found in emails using browser tools. Use your tools to answer questions. If you do not have a tool to answer the question, say so.
        """ +  """
